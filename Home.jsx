...
const ProductCardApp = () => {
  ...
  const [nextProductId, setNextProductId] = useState(1); // لتتبع المعرف التالي
  ...
  const addProduct = () => {
    ...
    setNextProductId(nextProductId + 1); // تحديث المعرف التالي
  };
  ...
  const updateProduct = (id) => {
    const updatedProducts = products.map((product) =>
      product.id === id
        ? { ...product, price: product.price + 10 } // زيادة السعر بـ 10
        : product
    );
